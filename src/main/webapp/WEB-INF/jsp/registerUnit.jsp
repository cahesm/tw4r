...
.finalPrice
{
    ...
    font-size: 12px;
      ...
      <script>
         ...
         let addDisponibility = function () 
         {
            ...
            let fields = ['nights:int', 'startDate:date', 'endDate:date', 'price:double'];         
   ...
   <div class="hd_center_container">
    <div class="center" id="hd_dashboard_horzmenu">       
       <form:form id="unitForm" method="post" modelAttribute="unit" action="processUnit.html">

       <div class = "panel-group">
            <div class = "panel panel-default">
                <div class = "panel-heading">
                    <h4 class = "panel-title">
                         <a data-toggle = "collapse" href = "#unitInf">Registro de Unidade</a>                       
                    </h4>
                ...
                <div id = "unitInf" class = "collapse show" aria-expanded="true">
                    <div class = "panel-body noBottomRadius">
                        <div class="form-group">
                            ...
                            <form:errors path="idHotel" cssClass="error"/>
                            <a  href="requestHotel.html">Não encontrou seu Hotel?</a> 
                        </div> 
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2" value="${unit.bathRoom}" var="bath"/>
            ...
            <div class = "panel panel-default">
                ...
                <div id = "unitDisp" class = "collapse show" aria-expanded="true">
                    <div class = "panel-body noBottomRadius">
                            ...
                            <div id="dispListContainer" class="table-responsive" style="display:none">
                            ...
                            <c:forEach items="${unit.medias}" var="medias" varStatus="status">
                                <div class="img-item">
                                    ...
                                    <form:hidden id="medias${status.index}.name" path="medias[${status.index}].name"/> 
                                            <div class="resort-image" style="background-image: url(${pageContext.request.contextPath}/images/temp/units/${medias.name})"> </div>    
