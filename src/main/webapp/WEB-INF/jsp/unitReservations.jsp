            ...
            <div class = "panel panel-default">
                ...
                <div id = "reservationList" class = "panel-collapse expand">
                    <div class = "panel-body">   
                        <div class="input-group p-3">
                            <input id="w-input-search-reservation" type="text" class="form-control" placeholder="Procure pelo código da reserva..." aria-label="Recipient's username" aria-describedby="basic-addon2" value="${unitReservationsSearch.cod}">                        
                ...
                <div class = "panel-footer" style="height: 35px" >
                    <h4 class = "panel-title">   
                        ...
                        <i  class="records-count"> ( ${unitReservationsSearch.page} de ${unitReservationsSearch.pages} )</i> 
                        <i  class="fa fa-caret-left caret" onclick="backward()"></i>
                        <i  class="records-total"> ${unitReservationsSearch.total} registros </i>                                                 
                    </h4>              
                  
                </div>
                 <div id="addCommentDialog" class="modal fade position-absolute" role="dialog">
